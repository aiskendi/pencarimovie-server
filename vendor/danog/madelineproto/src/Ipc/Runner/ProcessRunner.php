        ...
        $envVars = array_merge(
            ...
            (static function (): array {
                ...
                $allowed = $isWindows ? [
                    ...
                    'HOMEDRIVE', 'HOMEPATH', 'USERPROFILE', 'SystemDrive',
                    'ProgramFiles', 'ProgramFiles(x86)', 'ProgramW6432',
                    'APPDATA', 'LOCALAPPDATA', 'NUMBER_OF_PROCESSORS',
                    'PROCESSOR_ARCHITECTURE', 'OS', 'COMPUTERNAME', 'USERNAME', 'windir'
                ] : [
                    'PATH', 'PREFIX', 'LD_LIBRARY_PATH', 'HOME', 'TMPDIR', 'TEMP', 'TMP',
                    'USER', 'SHELL', 'LANG', 'LC_ALL', 'PHP_INI_SCAN_DIR', 'PHPRC', 'TERM',
                    'ANDROID_DATA', 'ANDROID_ROOT'
                ];
